...
public class AutopayData {
    String category, id, note, date_limit, paymentType, repeatTransaction;
    double amount;
    ...
    public AutopayData(String category, String id, String note, String date_limit, String paymentType, String repeatTransaction, double amount) {
        this.category = category;
        this.id = id;
        this.note = note;
        this.date_limit = date_limit;
